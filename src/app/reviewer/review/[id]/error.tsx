...
export default function ReviewError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16 text-center">
      ...
      <p className="text-sm text-text-muted mb-6">We couldn't load this review. Please try again.</p>
      <div className="flex gap-3 justify-center">
        ...
        <Link href="/reviewer" className="border border-border hover:border-border-light px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">

    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-surface border border-border rounded-2xl p-8 shadow-sm">
        ...
        <button
          ...
          disabled={loading}
          className="github-btn w-full flex items-center justify-center gap-3 bg-[#24292f] hover:bg-[#32383f] disabled:opacity-50 text-white py-3 rounded-lg text-sm font-medium transition-colors"
        >
